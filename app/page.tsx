...
export default function HomePage() {
  ...
  const filteredCompanies = availableCompanies
    .filter((company: Supplier) => company.supplier_name.toLowerCase().includes(searchQuery.toLowerCase()))
    .slice(0, 10);
  ...
  const selectCompany = (companyName: string, companyUid: string) => {
    ...
    setShowDropdown(false);
    setSelectedIndex(-1);
    const isAvailable = availableCompanies.some(
      (company: Supplier) => company.supplier_name.toLowerCase() === companyName.toLowerCase()
    );
    ...
    sessionStorage.setItem(
      'selectedCompany',
      JSON.stringify({ companyName: companyName, companyUid: companyUid })
    );
  };
  ...
  return (
    <>
      ...
      <section id="search" className="pt-10 pb-5 lg:py-10 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-[#123F6D] mb-4">ตรวจสอบสิทธิ์</h3>
            <p className="text-lg text-gray-600">กรอกชื่อบริษัทเพื่อตรวจสอบสิทธิ์ของคุณ</p>
          </div>
            ...
            <div className="max-w-2xl mx-auto">
              {searchResult === 'available' ? (
                <div className="bg-green-50 border border-green-200 rounded-lg px-4 pt-4 pb-6 md:px-6 md:py-10 text-center">
                  ...
                  <h5 className="text-green-700 text-xl mb-4">
                    บริษัท <strong>{searchQuery}</strong>
                  </h5>
                  <div className="flex justify-center">
                    <Link
                      href="/submit"
                      className="bg-green-700 hover:bg-green-800 text-white px-8 py-4 rounded-lg font-semibold shadow-lg"
                    >
                ...
                <div className="bg-orange-50 border border-orange-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-orange-700 mb-4">
                    ยังไม่พบข้อมูลบริษัท <strong>{searchQuery}</strong> หากสนใจสมัครเป็นพาร์ทเนอร์กับ AssetWise
                    กรุณากรอกข้อมูลด้านล่าง
                  </p>
                  <a
                    href="#partner"
                    className="inline-flex items-center space-x-2 bg-[#F1683B] hover:bg-[#e5572f] text-white px-6 py-3 rounded-lg font-semibold transition-colors"
                  >
      ...
      <section id="partner" className="py-10 lg:py-20 bg-gray-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold text-[#123F6D] mb-4">สมัครเป็นพาร์ทเนอร์กับ AssetWise</h3>
            <p className="text-lg text-gray-600">กรอกข้อมูลบริษัทเพื่อสมัครเป็นพาร์ทเนอร์กับ AssetWise</p>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            <form name="partnerForm" onSubmit={handleBusinessSubmit} className="space-y-6">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">จำนวนพนักงาน</label>
                  <select
                ...
                <div>
                  <label className="block text-sm font-semibold text-gray-700 mb-2">กลุ่มธุรกิจ</label>
                  <input
                    type="text"
              ...
              <div className="flex items-start my-4">
                ...
                <label htmlFor="terms" className="ml-2 text-sm text-gray-700 select-none cursor-pointer">
                  ...
                  <a
                    ...
                    className="underline text-[#123F6D] hover:text-[#F1683B] transition"
                  >
